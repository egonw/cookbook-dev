...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/minify/HELP.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/minify/HELP.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="Minify" />
<meta property="og:description" content="Minify  Minify - a minifier of js, css, html and img files, used in Cloud Commander project.  To use minify as middleware try Mollify.  Install  NPM_INFO  You c" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/minify/HELP.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/minify/HELP.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/minify/HELP.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#optimize-file">
   Optimize file
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#optimize-data">
   Optimize data
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#express-middleware">
   Express middleware
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
...
<h1>Minify<a class="headerlink" href="#minify" title="Permalink to this headline">¶</a></h1>
<p><a class="reference external" href="http://coderaiser.github.io/minify">Minify</a> - a minifier of js, css, html and img files,
used in <a class="reference external" href="http://cloudcmd.io">Cloud Commander</a> project.</p>
<p>To use <code class="docutils literal notranslate"><span class="pre">minify</span></code> as middleware try <a class="reference external" href="https://github.com/coderaiser/node-mollify">Mollify</a>.</p>
<div class="section" id="install">
<h2>Install<a class="headerlink" href="#install" title="Permalink to this headline">¶</a></h2>
<p><img alt="NPM_INFO" src="https://nodei.co/npm/minify.png?stars" /></p>
<p>You can install minify via <a class="reference external" href="https://www.npmjs.org/">npm</a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">npm</span> <span class="n">i</span> <span class="n">minify</span> <span class="o">-</span><span class="n">g</span>
</pre></div>
</div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">minify</span> <span class="o">&lt;</span><span class="nb">input</span><span class="o">-</span><span class="n">file1</span><span class="o">&gt;</span> <span class="o">&lt;</span><span class="nb">input</span><span class="o">-</span><span class="n">file2</span><span class="o">&gt;</span> <span class="o">&lt;</span><span class="nb">input</span><span class="o">-</span><span class="n">fileN</span><span class="o">&gt;</span> <span class="o">&gt;</span> <span class="n">output</span>
<span class="n">stdout</span> <span class="o">|</span> <span class="n">minify</span> <span class="o">--&lt;</span><span class="n">flag</span><span class="o">&gt;</span>
</pre></div>
</div>
<p>For example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">minify</span> <span class="n">client</span><span class="o">.</span><span class="n">js</span> <span class="n">util</span><span class="o">.</span><span class="n">js</span> <span class="o">&gt;</span> <span class="nb">all</span><span class="o">.</span><span class="n">js</span>
<span class="n">minify</span> <span class="n">screen</span><span class="o">.</span><span class="n">css</span> <span class="n">reset</span><span class="o">.</span><span class="n">css</span> <span class="o">&gt;</span> <span class="nb">all</span><span class="o">.</span><span class="n">css</span>

<span class="n">cat</span> <span class="n">client</span><span class="o">.</span><span class="n">js</span> <span class="o">|</span> <span class="n">minify</span> <span class="o">--</span><span class="n">js</span>
<span class="n">cat</span> <span class="o">*.</span><span class="n">css</span> <span class="o">|</span> <span class="n">minify</span> <span class="o">--</span><span class="n">css</span>
</pre></div>
</div>
</div>
<div class="section" id="api">
<h2>API<a class="headerlink" href="#api" title="Permalink to this headline">¶</a></h2>
<p>The <strong>Minify</strong> module contains an api for interacting with other js files.</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">minify</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minify&#39;</span><span class="p">);</span>
</pre></div>
</div>
<p>After minification, a file will be saved in the temporary directory.</p>
<p>minify - function to minificate js, html and css-files.</p>
<ul class="simple">
<li><p><strong>file</strong>                 - path to file.</p></li>
<li><p><strong>options</strong>(optional)    - object contains options.</p></li>
<li><p><strong>callback</strong></p></li>
</ul>
...
<div class="section" id="optimize-file">
<h2>Optimize file<a class="headerlink" href="#optimize-file" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">minify</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minify&#39;</span><span class="p">);</span>

<span class="nx">minify</span><span class="p">(</span><span class="s1">&#39;client.js&#39;</span><span class="p">,</span> <span class="s1">&#39;name&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">name</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">error</span> <span class="o">||</span> <span class="nx">name</span><span class="p">);</span>
<span class="p">});</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">minify</span><span class="p">(</span><span class="s1">&#39;client.js&#39;</span><span class="p">,</span> <span class="s1">&#39;stream&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">stream</span><span class="p">)</span> <span class="p">{</span>
    <span class="kd">var</span> <span class="nx">streamWrite</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">createWriteStream</span><span class="p">(</span><span class="s1">&#39;client.min.js&#39;</span><span class="p">);</span>
    ...
    <span class="k">else</span>
        <span class="nx">stream</span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">streamWrite</span><span class="p">);</span>
<span class="p">});</span>
</pre></div>
</div>
<p>if post processing is need:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">minify</span><span class="p">(</span><span class="s1">&#39;client.js&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span>

<span class="p">});</span>
</pre></div>
</div>
</div>
<div class="section" id="optimize-data">
<h2>Optimize data<a class="headerlink" href="#optimize-data" title="Permalink to this headline">¶</a></h2>
<p>Parameters:</p>
<ul class="simple">
<li><p>Data</p></li>
<li><p>Callback</p></li>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">minify</span><span class="p">.</span><span class="nx">js</span><span class="p">(</span><span class="s1">&#39;function hello() { if (2 &gt; 3) console.log(\&#39;for real\&#39;)}&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nx">minify</span><span class="p">.</span><span class="nx">css</span><span class="p">(</span><span class="s1">&#39;div { color: #000000}&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">data</span><span class="p">);</span>
<span class="p">});</span>
</pre></div>
</div>
...
<h2>Express middleware<a class="headerlink" href="#express-middleware" title="Permalink to this headline">¶</a></h2>
<p>To use as express middleware [mollify](<a class="reference external" href="https://github.com/coderaiser/node-mollify">https://github.com/coderaiser/node-mollify</a> Mollify) could be used.</p>
</div>
