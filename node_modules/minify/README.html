...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/minify/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/minify/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="Minify    " />
<meta property="og:description" content="Minify License Dependency Status Build Status NPM version  Minify - a minifier of js, css, html and img files. To use minify as middleware try Mollify.  Install" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/minify/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/minify/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/minify/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="minify-license-dependency-status-build-status-npm-version">
<h1>Minify <a class="reference external" href="https://tldrlegal.com/license/mit-license"><img alt="License" src="https://img.shields.io/badge/license-MIT-317BF9.svg?style=flat" /></a> <a class="reference external" href="https://david-dm.org/coderaiser/minify"><img alt="Dependency Status" src="https://img.shields.io/david/coderaiser/minify.svg?style=flat" /></a> <a class="reference external" href="http://travis-ci.org/coderaiser/minify"><img alt="Build Status" src="https://img.shields.io/travis/coderaiser/minify/master.svg?style=flat" /></a> <a class="reference external" href="http://npmjs.org/package/minify"><img alt="NPM version" src="https://img.shields.io/npm/v/minify.svg?style=flat" /></a><a class="headerlink" href="#minify-license-dependency-status-build-status-npm-version" title="Permalink to this headline">¶</a></h1>
<p><a class="reference external" href="http://coderaiser.github.io/minify">Minify</a> - a minifier of js, css, html and img files.
To use <code class="docutils literal notranslate"><span class="pre">minify</span></code> as middleware try <a class="reference external" href="https://github.com/coderaiser/node-mollify">Mollify</a>.</p>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">$</span> <span class="nx">cat</span> <span class="o">&gt;</span> <span class="nx">hello</span><span class="p">.</span><span class="nx">js</span>
<span class="kd">const</span> <span class="nx">hello</span> <span class="o">=</span> <span class="s1">&#39;world&#39;</span><span class="p">;</span>

<span class="k">for</span> <span class="p">(</span><span class="kd">let</span> <span class="nx">i</span> <span class="o">=</span> <span class="mf">0</span><span class="p">;</span> <span class="nx">i</span> <span class="o">&lt;</span> <span class="nx">hello</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span> <span class="nx">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">hello</span><span class="p">[</span><span class="nx">i</span><span class="p">]);</span>
<span class="p">}</span>
<span class="o">^</span><span class="nx">D</span>

<span class="nx">$</span> <span class="nx">minify</span> <span class="nx">hello</span><span class="p">.</span><span class="nx">js</span>
<span class="kd">const</span> <span class="nx">hello</span><span class="o">=</span><span class="s2">&quot;world&quot;</span><span class="p">;</span><span class="k">for</span><span class="p">(</span><span class="kd">let</span> <span class="nx">l</span><span class="o">=</span><span class="mf">0</span><span class="p">;</span><span class="nx">l</span><span class="o">&lt;</span><span class="nx">hello</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span><span class="nx">l</span><span class="o">++</span><span class="p">)</span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">hello</span><span class="p">[</span><span class="nx">l</span><span class="p">]);</span>
</pre></div>
</div>
</div>
<div class="section" id="code-example">
<h3>Code Example<a class="headerlink" href="#code-example" title="Permalink to this headline">¶</a></h3>
<p><code class="docutils literal notranslate"><span class="pre">minify</span></code> can be used as a <code class="docutils literal notranslate"><span class="pre">promise</span></code>:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">minify</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minify&#39;</span><span class="p">);</span>

<span class="nx">minify</span><span class="p">(</span><span class="s1">&#39;./client.js&#39;</span><span class="p">)</span>
    <span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">)</span>
    <span class="p">.</span><span class="k">catch</span><span class="p">(</span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">);</span>
</pre></div>
</div>
<p>Or with <code class="docutils literal notranslate"><span class="pre">async-await</span></code> and <a class="reference external" href="https://github.com/coderaiser/try-to-catch%27">try-to-catch</a>:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">minify</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minify&#39;</span><span class="p">);</span>
...
<span class="k">async</span> <span class="p">()</span> <span class="p">=&gt;</span> <span class="p">{</span>
    <span class="kd">const</span> <span class="p">[</span><span class="nx">error</span><span class="p">,</span> <span class="nx">data</span><span class="p">]</span> <span class="o">=</span> <span class="k">await</span> <span class="nx">tryToCatch</span><span class="p">(</span><span class="nx">minify</span><span class="p">,</span> <span class="s1">&#39;./client.js&#39;</span><span class="p">);</span>
    
    <span class="k">if</span> <span class="p">(</span><span class="nx">error</span><span class="p">)</span>
        <span class="k">return</span> <span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="nx">error</span><span class="p">.</span><span class="nx">message</span><span class="p">);</span>
