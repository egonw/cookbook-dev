...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/entity-decode/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/entity-decode/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="entity-decode" />
<meta property="og:description" content="entity-decode  This purpose of this library is to provide a single interface to browser and node decode implementation.  It is using the following two underlyin" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/entity-decode/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/entity-decode/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/entity-decode/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="entity-decode">
<h1>entity-decode<a class="headerlink" href="#entity-decode" title="Permalink to this headline">¶</a></h1>
<p>This purpose of this library is to provide a single interface to browser and node decode implementation.</p>
<p>It is using the following two underlying implementations:</p>
<ul class="simple">
<li><p>Browser: micro decode implementation using browser’s NodeElement.textContent method</p></li>
<li><p>Node: <a class="reference external" href="https://github.com/mathiasbynens/he">he</a></p></li>
</ul>
<div class="section" id="example-usage">
<h2>Example usage<a class="headerlink" href="#example-usage" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="c1">// Load default implementation</span>
<span class="kd">var</span> <span class="nx">decode</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;entity-decode&#39;</span><span class="p">);</span>

<span class="c1">// Load specific version</span>
<span class="kd">var</span> <span class="nx">decode</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;entity-decode/browser&#39;</span><span class="p">)</span> <span class="c1">// browser version</span>
<span class="kd">var</span> <span class="nx">decode</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;entity-decode/node&#39;</span><span class="p">)</span> <span class="c1">// node version</span>

<span class="nx">decode</span><span class="p">(</span><span class="s1">&#39;foo &amp;copy; bar &amp;ne; baz &amp;#x1D306; qux&#39;</span><span class="p">)</span> 
<span class="c1">// returns &#39;foo © bar ≠ baz 𝌆 qux&#39;</span>
</pre></div>
</div>
</div>
<div class="section" id="license">
<h2>License<a class="headerlink" href="#license" title="Permalink to this headline">¶</a></h2>
<p>entity-decode is available under the <a class="reference external" href="https://mths.be/mit">MIT</a> license.</p>
</div>
</div>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./node_modules/entity-decode"
        },
