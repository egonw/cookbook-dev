...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/@braintree/sanitize-url/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/@braintree/sanitize-url/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="sanitize-url" />
<meta property="og:description" content="sanitize-url  Installation  npm install -S @braintree/sanitize-url   Usage  var sanitizeUrl = require(&#39;@braintree/sanitize-url&#39;).sanitizeUrl;  sanitizeUrl(&#39;http" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../_sources/node_modules/@braintree/sanitize-url/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/@braintree/sanitize-url/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/@braintree/sanitize-url/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="sanitize-url">
<h1>sanitize-url<a class="headerlink" href="#sanitize-url" title="Permalink to this headline">¶</a></h1>
<div class="section" id="installation">
<h2>Installation<a class="headerlink" href="#installation" title="Permalink to this headline">¶</a></h2>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>npm install -S @braintree/sanitize-url
</pre></div>
</div>
</div>
<div class="section" id="usage">
<h2>Usage<a class="headerlink" href="#usage" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">sanitizeUrl</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;@braintree/sanitize-url&#39;</span><span class="p">).</span><span class="nx">sanitizeUrl</span><span class="p">;</span>

<span class="nx">sanitizeUrl</span><span class="p">(</span><span class="s1">&#39;https://example.com&#39;</span><span class="p">);</span> <span class="c1">// &#39;https://example.com&#39;</span>
<span class="nx">sanitizeUrl</span><span class="p">(</span><span class="s1">&#39;http://example.com&#39;</span><span class="p">);</span> <span class="c1">// &#39;http://example.com&#39;</span>
<span class="nx">sanitizeUrl</span><span class="p">(</span><span class="s1">&#39;mailto:hello@example.com&#39;</span><span class="p">);</span> <span class="c1">// &#39;mailto:hello@example.com&#39;</span>

<span class="nx">sanitizeUrl</span><span class="p">(</span><span class="s1">&#39;javascript:alert(document.domain)&#39;</span><span class="p">);</span> <span class="c1">// &#39;about:blank&#39;</span>
<span class="nx">sanitizeUrl</span><span class="p">(</span><span class="s1">&#39;jAvasCrIPT:alert(document.domain)&#39;</span><span class="p">);</span> <span class="c1">// &#39;about:blank&#39;</span>
<span class="nx">sanitizeUrl</span><span class="p">(</span><span class="nb">decodeURIComponent</span><span class="p">(</span><span class="s1">&#39;JaVaScRiP%0at:alert(document.domain)&#39;</span><span class="p">));</span> <span class="c1">// &#39;about:blank&#39;</span>
</pre></div>
</div>
</div>
</div>
