...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/d3-voronoi/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/d3-voronoi/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="d3-voronoi" />
<meta property="og:description" content="d3-voronoi  Deprecation notice: Consider using the newer d3-delaunay instead of d3-voronoi. Based on Delaunator, d3-delaunay is 5-10× faster than d3-voronoi to " />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/d3-voronoi/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/d3-voronoi/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/d3-voronoi/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="d3-voronoi">
<h1>d3-voronoi<a class="headerlink" href="#d3-voronoi" title="Permalink to this headline">¶</a></h1>
<p><strong>Deprecation notice</strong>: Consider using the newer <a class="reference external" href="https://github.com/d3/d3-delaunay">d3-delaunay</a> instead of d3-voronoi. Based on <a class="reference external" href="https://github.com/mapbox/delaunator">Delaunator</a>, d3-delaunay is 5-10× faster than d3-voronoi to construct the Delaunay triangulation or the Voronoi diagram, is more robust numerically, has Canvas rendering built-in, allows traversal of the Delaunay graph, and a variety of other improvements.</p>
<hr class="docutils" />
<p>This module implements <a class="reference external" href="https://en.wikipedia.org/wiki/Fortune%27s_algorithm">Steven J. Fortune’s algorithm</a> for computing the <a class="reference external" href="https://en.wikipedia.org/wiki/Voronoi_diagram">Voronoi diagram</a> or <a class="reference external" href="https://en.wikipedia.org/wiki/Delaunay_triangulation">Delaunay triangulation</a> of a set of two-dimensional points. This implementation is largely based on <a class="reference external" href="http://www.raymondhill.net/voronoi/rhill-voronoi.html">work by Raymond Hill</a>.</p>
<p>Voronoi diagrams are not only <a class="reference external" href="http://bl.ocks.org/mbostock/4360892">visually</a> <a class="reference external" href="http://bl.ocks.org/mbostock/4636377">attractive</a> but practical tools for interaction, such as to increase the target area of points in a scatterplot. See <a class="reference external" href="http://www.nytimes.com/interactive/2013/03/29/sports/baseball/Strikeouts-Are-Still-Soaring.html">“Strikeouts on the Rise”</a> in <em>The New York Times</em> and this <a class="reference external" href="http://bl.ocks.org/mbostock/8033015">multi-line chart</a> for examples; also see Tovi Grossman’s paper on <a class="reference external" href="http://www.tovigrossman.com/BubbleCursor">bubble cursors</a> for a related technique. Voronoi diagrams can also be used to <a class="reference external" href="http://bl.ocks.org/mbostock/6909318">automate label positioning</a>, and Delaunay meshes are useful in computing adjacency or grouping of visual elements.</p>
...
<p>If you use NPM, <code class="docutils literal notranslate"><span class="pre">npm</span> <span class="pre">install</span> <span class="pre">d3-voronoi</span></code>. Otherwise, download the <a class="reference external" href="https://github.com/d3/d3-voronoi/releases/latest">latest release</a>. You can also load directly from <a class="reference external" href="https://d3js.org">d3js.org</a>, either as a <a class="reference external" href="https://d3js.org/d3-voronoi.v1.min.js">standalone library</a> or as part of <a class="reference external" href="https://github.com/d3/d3">D3 4.0</a>. AMD, CommonJS, and vanilla environments are supported. In vanilla, a <code class="docutils literal notranslate"><span class="pre">d3</span></code> global is exported:</p>
<div class="highlight-html notranslate"><div class="highlight"><pre><span></span><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;https://d3js.org/d3-voronoi.v1.min.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
<span class="p">&lt;</span><span class="nt">script</span><span class="p">&gt;</span>

<span class="kd">var</span> <span class="nx">voronoi</span> <span class="o">=</span> <span class="nx">d3</span><span class="p">.</span><span class="nx">voronoi</span><span class="p">();</span>

<span class="p">&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</pre></div>
</div>
<p><a class="reference external" href="https://tonicdev.com/npm/d3-voronoi">Try d3-voronoi in your browser.</a></p>
</div>
<div class="section" id="api-reference">
<h2>API Reference<a class="headerlink" href="#api-reference" title="Permalink to this headline">¶</a></h2>
<p><a name="voronoi" href="#voronoi">#</a> d3.<b>voronoi</b>() <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js">&lt;&gt;</a></p>
<p>Creates a new Voronoi layout with default <a class="reference external" href="#voronoi_x"><em>x</em>-</a> and <a class="reference external" href="#voronoi_y"><em>y</em>-</a> accessors and a null <a class="reference external" href="#voronoi_extent">extent</a>.</p>
<p><a name="_voronoi" href="#_voronoi">#</a> <i>voronoi</i>(<i>data</i>) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L10">&lt;&gt;</a></p>
<p>Computes the <a class="reference external" href="#voronoi-diagrams">Voronoi diagram</a> for the specified <em>data</em> points.</p>
<p><a name="voronoi_x" href="#voronoi_x">#</a> <i>voronoi</i>.<b>x</b>([<i>x</i>]) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L31">&lt;&gt;</a></p>
...
<p><a name="voronoi_y" href="#voronoi_y">#</a> <i>voronoi</i>.<b>y</b>([<i>y</i>]) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L35">&lt;&gt;</a></p>
...
<p><a name="voronoi_extent" href="#voronoi_extent">#</a> <i>voronoi</i>.<b>extent</b>([<i>extent</i>]) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L39">&lt;&gt;</a></p>
<p>If <em>extent</em> is specified, sets the clip extent of the Voronoi layout to the specified bounds and returns the layout. The <em>extent</em> bounds are specified as an array [[<i>x0</i>, <i>y0</i>], [<i>x1</i>, <i>y1</i>]], where <i>x0</i> is the left side of the extent, <i>y0</i> is the top, <i>x1</i> is the right and <i>y1</i> is the bottom. If <em>extent</em> is not specified, returns the current clip extent which defaults to null. A clip extent is required when using <a class="reference external" href="#voronoi_polygons"><em>voronoi</em>.polygons</a>.</p>
<p><a name="voronoi_size" href="#voronoi_size">#</a> <i>voronoi</i>.<b>size</b>([<i>size</i>]) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L43">&lt;&gt;</a></p>
<p>An alias for <a class="reference external" href="#voronoi_extent"><em>voronoi</em>.extent</a> where the minimum <em>x</em> and <em>y</em> of the extent are ⟨0,0⟩. Equivalent to:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">voronoi</span><span class="p">.</span><span class="nx">extent</span><span class="p">([[</span><span class="mf">0</span><span class="p">,</span> <span class="mf">0</span><span class="p">],</span> <span class="nx">size</span><span class="p">]);</span>
</pre></div>
</div>
<p><a name="voronoi_polygons" href="#voronoi_polygons">#</a> <i>voronoi</i>.<b>polygons</b>(<i>data</i>) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L19">&lt;&gt;</a></p>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">voronoi</span><span class="p">(</span><span class="nx">data</span><span class="p">).</span><span class="nx">polygons</span><span class="p">();</span>
</pre></div>
</div>
<p>See <a class="reference external" href="#diagram_polygons"><em>diagram</em>.polygons</a> for more detail. Note: an <a class="reference external" href="#voronoi_extent">extent</a> is required.</p>
<p><a name="voronoi_triangles" href="#voronoi_triangles">#</a> <i>voronoi</i>.<b>triangles</b>(<i>data</i>) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L27">&lt;&gt;</a></p>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">voronoi</span><span class="p">(</span><span class="nx">data</span><span class="p">).</span><span class="nx">triangles</span><span class="p">();</span>
</pre></div>
</div>
<p>See <a class="reference external" href="#diagram_triangles"><em>diagram</em>.triangles</a> for more detail.</p>
<p><a name="voronoi_links" href="#voronoi_links">#</a> <i>voronoi</i>.<b>links</b>(<i>data</i>) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/voronoi.js#L23">&lt;&gt;</a></p>
<p>Returns the Delaunay triangulation of the specified <em>data</em> array as an array of links. Each link has <code class="docutils literal notranslate"><span class="pre">source</span></code> and <code class="docutils literal notranslate"><span class="pre">target</span></code> attributes referring to elements in <em>data</em>. Equivalent to:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">voronoi</span><span class="p">(</span><span class="nx">data</span><span class="p">).</span><span class="nx">links</span><span class="p">();</span>
</pre></div>
</div>
<p>See <a class="reference external" href="#diagram_links"><em>diagram</em>.links</a> for more detail.</p>
<div class="section" id="voronoi-diagrams">
<h3>Voronoi Diagrams<a class="headerlink" href="#voronoi-diagrams" title="Permalink to this headline">¶</a></h3>
<p><a name="diagram" href="#diagram">#</a> <i>diagram</i> <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/Diagram.js">&lt;&gt;</a></p>
<p>The computed Voronoi diagram returned by <a class="reference external" href="#_voronoi"><em>voronoi</em></a> has the following properties:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">edges</span></code> - an array of <a class="reference external" href="#diagram_edge">edges</a>.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">cells</span></code> - a sparse array of <a class="reference external" href="#diagram_cell">cells</a>, one for each unique input point.</p></li>
</ul>
...
<p><a name="diagram_polygons" href="#diagram_polygons">#</a> <i>diagram</i>.<b>polygons</b>() <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/Diagram.js#L72">&lt;&gt;</a></p>
<p>Returns a sparse array of polygons clipped to the <a class="reference external" href="#voronoi_extent"><em>extent</em></a>, one for each cell (each unique input point) in the diagram. Each polygon is represented as an array of points [<em>x</em>, <em>y</em>] where <em>x</em> and <em>y</em> are the point coordinates, and a <code class="docutils literal notranslate"><span class="pre">data</span></code> field that refers to the corresponding element in <em>data</em>. Polygons are open: they do not contain a closing point that duplicates the first point; a triangle, for example, is an array of three points. Polygons are also counterclockwise, assuming the origin ⟨0,0⟩ is in the top-left corner.</p>
...
<p><a name="diagram_triangles" href="#diagram_triangles">#</a> <i>diagram</i>.<b>triangles</b>() <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/Diagram.js#L82">&lt;&gt;</a></p>
<p>Returns the Delaunay triangulation of the specified <em>data</em> array as an array of triangles. Each triangle is a three-element array of elements from <em>data</em>. Since the triangulation is computed as the dual of the Voronoi diagram, and the Voronoi diagram is clipped by the <a class="reference external" href="#voronoi_extent">extent</a>, a subset of the Delaunay triangulation is returned.</p>
<p><a name="diagram_links" href="#diagram_links">#</a> <i>diagram</i>.<b>links</b>() <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/Diagram.js#L108">&lt;&gt;</a></p>
...
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">source</span></code> - the source node, an element in <em>data</em>.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">target</span></code> - the target node, an element in <em>data</em>.</p></li>
</ul>
<p>Since the triangulation is computed as the dual of the Voronoi diagram, and the Voronoi diagram is clipped by the <a class="reference external" href="#voronoi_extent">extent</a>, a subset of the Delaunay links is returned.</p>
<p><a name="diagram_find" href="#diagram_find">#</a> <i>diagram</i>.<b>find</b>(<i>x</i>, <i>y</i>[, <i>radius</i>]) <a class="reference external" href="https://github.com/d3/d3-voronoi/blob/master/src/Diagram.js#L119">&lt;&gt;</a></p>
...
<p>See Philippe Rivière’s <a class="reference external" href="http://bl.ocks.org/Fil/1b7ddbcd71454d685d1259781968aefc">bl.ocks.org/1b7ddbcd71454d685d1259781968aefc</a> for an example.</p>
<p><a name="cell" href="#cell">#</a> <i>cell</i></p>
<p>Each cell in the diagram is an object with the following properties:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">site</span></code> - the <a class="reference external" href="#site">site</a> of the cell’s associated input point.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">halfedges</span></code> - an array of indexes into <a class="reference external" href="#diagram"><em>diagram</em>.edges</a> representing the cell’s polygon.</p></li>
</ul>
...
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">index</span></code> - the site’s index, corresponding to the associated input point.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">data</span></code> - the input data corresponding to this site.</p></li>
</ul>
...
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">left</span></code> - the <a class="reference external" href="#site">site</a> on the left side of the edge.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">right</span></code> - the <a class="reference external" href="#site">site</a> on the right side of the edge; null for a clipped border edge.</p></li>
</ul>
</div>
</div>
</div>
