...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/d3-random/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/d3-random/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="d3-random" />
<meta property="og:description" content="d3-random  Generate random numbers from various distributions.  Installing  If you use NPM, npm install d3-random. Otherwise, download the latest release. You c" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/d3-random/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/d3-random/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/d3-random/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="d3-random">
<h1>d3-random<a class="headerlink" href="#d3-random" title="Permalink to this headline">¶</a></h1>
<p>Generate random numbers from various distributions.</p>
<div class="section" id="installing">
<h2>Installing<a class="headerlink" href="#installing" title="Permalink to this headline">¶</a></h2>
<p>If you use NPM, <code class="docutils literal notranslate"><span class="pre">npm</span> <span class="pre">install</span> <span class="pre">d3-random</span></code>. Otherwise, download the <a class="reference external" href="https://github.com/d3/d3-random/releases/latest">latest release</a>. You can also load directly from <a class="reference external" href="https://d3js.org">d3js.org</a>, either as a <a class="reference external" href="https://d3js.org/d3-random.v1.min.js">standalone library</a> or as part of <a class="reference external" href="https://github.com/d3/d3">D3 4.0</a>. AMD, CommonJS, and vanilla environments are supported. In vanilla, a <code class="docutils literal notranslate"><span class="pre">d3</span></code> global is exported:</p>
<div class="highlight-html notranslate"><div class="highlight"><pre><span></span><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;https://d3js.org/d3-random.v1.min.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
<span class="p">&lt;</span><span class="nt">script</span><span class="p">&gt;</span>

<span class="kd">var</span> <span class="nx">random</span> <span class="o">=</span> <span class="nx">d3</span><span class="p">.</span><span class="nx">randomUniform</span><span class="p">(</span><span class="mf">1</span><span class="p">,</span> <span class="mf">10</span><span class="p">);</span>

<span class="p">&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</pre></div>
</div>
<p><a class="reference external" href="https://runkit.com/npm/d3-random">Try d3-random in your browser.</a></p>
</div>
<div class="section" id="api-reference">
<h2>API Reference<a class="headerlink" href="#api-reference" title="Permalink to this headline">¶</a></h2>
<p><a name="randomUniform" href="#randomUniform">#</a> d3.<b>randomUniform</b>([<i>min</i>, ][<i>max</i>]) <a class="reference external" href="https://github.com/d3/d3-random/blob/master/src/uniform.js">&lt;&gt;</a></p>
<p>Returns a function for generating random numbers with a <a class="reference external" href="https://en.wikipedia.org/wiki/Uniform_distribution_%5C(continuous%5C)">uniform distribution</a>. The minimum allowed value of a returned number is <em>min</em>, and the maximum is <em>max</em>. If <em>min</em> is not specified, it defaults to 0; if <em>max</em> is not specified, it defaults to 1. For example:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">d3</span><span class="p">.</span><span class="nx">randomUniform</span><span class="p">(</span><span class="mf">6</span><span class="p">)();</span> <span class="c1">// Returns a number greater than or equal to 0 and less than 6.</span>
<span class="nx">d3</span><span class="p">.</span><span class="nx">randomUniform</span><span class="p">(</span><span class="mf">1</span><span class="p">,</span> <span class="mf">5</span><span class="p">)();</span> <span class="c1">// Returns a number greater than or equal to 1 and less than 5.</span>
</pre></div>
</div>
<p>Note that you can also use the built-in <a class="reference external" href="https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/Math/random">Math.random</a> to generate uniform distributions directly. For example, to generate a random integer between 0 and 99 (inclusive), you can say <code class="docutils literal notranslate"><span class="pre">Math.random()</span> <span class="pre">*</span> <span class="pre">100</span> <span class="pre">|</span> <span class="pre">0</span></code>.</p>
<p><a name="randomNormal" href="#randomNormal">#</a> d3.<b>randomNormal</b>([<i>mu</i>][, <i>sigma</i>]) <a class="reference external" href="https://github.com/d3/d3-random/blob/master/src/normal.js">&lt;&gt;</a></p>
<p>Returns a function for generating random numbers with a <a class="reference external" href="https://en.wikipedia.org/wiki/Normal_distribution">normal (Gaussian) distribution</a>. The expected value of the generated numbers is <em>mu</em>, with the given standard deviation <em>sigma</em>. If <em>mu</em> is not specified, it defaults to 0; if <em>sigma</em> is not specified, it defaults to 1.</p>
<p><a name="randomLogNormal" href="#randomLogNormal">#</a> d3.<b>randomLogNormal</b>([<i>mu</i>][, <i>sigma</i>]) <a class="reference external" href="https://github.com/d3/d3-random/blob/master/src/logNormal.js">&lt;&gt;</a></p>
<p>Returns a function for generating random numbers with a <a class="reference external" href="https://en.wikipedia.org/wiki/Log-normal_distribution">log-normal distribution</a>. The expected value of the random variable’s natural logarithm is <em>mu</em>, with the given standard deviation <em>sigma</em>. If <em>mu</em> is not specified, it defaults to 0; if <em>sigma</em> is not specified, it defaults to 1.</p>
<p><a name="randomBates" href="#randomBates">#</a> d3.<b>randomBates</b>(<i>n</i>) <a class="reference external" href="https://github.com/d3/d3-random/blob/master/src/bates.js">&lt;&gt;</a></p>
<p>Returns a function for generating random numbers with a <a class="reference external" href="https://en.wikipedia.org/wiki/Bates_distribution">Bates distribution</a> with <em>n</em> independent variables.</p>
<p><a name="randomIrwinHall" href="#randomIrwinHall">#</a> d3.<b>randomIrwinHall</b>(<i>n</i>) <a class="reference external" href="https://github.com/d3/d3-random/blob/master/src/irwinHall.js">&lt;&gt;</a></p>
<p>Returns a function for generating random numbers with an <a class="reference external" href="https://en.wikipedia.org/wiki/Irwin%E2%80%93Hall_distribution">Irwin–Hall distribution</a> with <em>n</em> independent variables.</p>
<p><a name="randomExponential" href="#randomExponential">#</a> d3.<b>randomExponential</b>(<i>lambda</i>) <a class="reference external" href="https://github.com/d3/d3-random/blob/master/src/exponential.js">&lt;&gt;</a></p>
<p>Returns a function for generating random numbers with an <a class="reference external" href="https://en.wikipedia.org/wiki/Exponential_distribution">exponential distribution</a> with the rate <em>lambda</em>; equivalent to time between events in a <a class="reference external" href="https://en.wikipedia.org/wiki/Poisson_point_process">Poisson process</a> with a mean of 1 / <em>lambda</em>. For example, exponential(1/40) generates random times between events where, on average, one event occurs every 40 units of time.</p>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">d3</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;d3-random&quot;</span><span class="p">),</span>
    <span class="nx">seedrandom</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;seedrandom&quot;</span><span class="p">),</span>
    <span class="nx">random</span> <span class="o">=</span> <span class="nx">d3</span><span class="p">.</span><span class="nx">randomNormal</span><span class="p">.</span><span class="nx">source</span><span class="p">(</span><span class="nx">seedrandom</span><span class="p">(</span><span class="s2">&quot;a22ebc7c488a3a47&quot;</span><span class="p">))(</span><span class="mf">0</span><span class="p">,</span> <span class="mf">1</span><span class="p">);</span>

<span class="nx">random</span><span class="p">();</span> <span class="c1">// 0.9744193494813501</span>
</pre></div>
</div>
</div>
</div>
