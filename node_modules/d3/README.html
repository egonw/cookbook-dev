...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/d3/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/d3/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="D3: Data-Driven Documents" />
<meta property="og:description" content="D3: Data-Driven Documents  &lt;a href=&#34;https://d3js.org&#34;&gt;&lt;img src=&#34;https://d3js.org/logo.svg&#34; align=&#34;left&#34; hspace=&#34;10&#34; vspace=&#34;6&#34;&gt;&lt;/a&gt;  D3 (or D3.js) is a JavaScri" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/d3/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/d3/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/d3/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="d3-data-driven-documents">
<h1>D3: Data-Driven Documents<a class="headerlink" href="#d3-data-driven-documents" title="Permalink to this headline">¶</a></h1>
...
<ul class="simple">
<li><p><a class="reference external" href="https://observablehq.com/&#64;d3/learn-d3">Introduction</a></p></li>
<li><p><a class="reference external" href="https://github.com/d3/d3/blob/master/API.md">API Reference</a></p></li>
...
<li><p><a class="reference external" href="https://github.com/d3/d3/wiki">Wiki</a></p></li>
</ul>
</div>
<div class="section" id="installing">
<h2>Installing<a class="headerlink" href="#installing" title="Permalink to this headline">¶</a></h2>
<p>If you use npm, <code class="docutils literal notranslate"><span class="pre">npm</span> <span class="pre">install</span> <span class="pre">d3</span></code>. Otherwise, download the <a class="reference external" href="https://github.com/d3/d3/releases/latest">latest release</a>. The released bundle supports anonymous AMD, CommonJS, and vanilla environments. You can load directly from <a class="reference external" href="https://d3js.org">d3js.org</a>, <a class="reference external" href="https://cdnjs.com/libraries/d3">CDNJS</a>, or <a class="reference external" href="https://unpkg.com/d3/">unpkg</a>. For example:</p>
<div class="highlight-html notranslate"><div class="highlight"><pre><span></span><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;https://d3js.org/d3.v5.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</pre></div>
</div>
...
<p>You can also use the standalone D3 microlibraries. For example, <a class="reference external" href="https://github.com/d3/d3-selection">d3-selection</a>:</p>
...
<p>D3 is written using <a class="reference external" href="http://www.2ality.com/2014/09/es6-modules-final.html">ES2015 modules</a>. Create a <a class="reference external" href="https://bl.ocks.org/mbostock/bb09af4c39c79cffcde4">custom bundle using Rollup</a>, Webpack, or your preferred bundler. To import D3 into an ES2015 application, either import specific symbols from specific D3 modules:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">import</span> <span class="p">{</span><span class="nx">scaleLinear</span><span class="p">}</span> <span class="nx">from</span> <span class="s2">&quot;d3-scale&quot;</span><span class="p">;</span>
</pre></div>
</div>
<p>Or import everything into a namespace (here, <code class="docutils literal notranslate"><span class="pre">d3</span></code>):</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">import</span> <span class="o">*</span> <span class="nx">as</span> <span class="nx">d3</span> <span class="nx">from</span> <span class="s2">&quot;d3&quot;</span><span class="p">;</span>
</pre></div>
</div>
<p>In Node:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">d3</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;d3&quot;</span><span class="p">);</span>
</pre></div>
</div>
<p>You can also require individual modules and combine them into a <code class="docutils literal notranslate"><span class="pre">d3</span></code> object using <a class="reference external" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign">Object.assign</a>:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">d3</span> <span class="o">=</span> <span class="nb">Object</span><span class="p">.</span><span class="nx">assign</span><span class="p">({},</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;d3-format&quot;</span><span class="p">),</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;d3-geo&quot;</span><span class="p">),</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;d3-geo-projection&quot;</span><span class="p">));</span>
</pre></div>
</div>
</div>
</div>
