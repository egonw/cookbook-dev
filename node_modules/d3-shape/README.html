...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/d3-shape/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/d3-shape/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="d3-shape" />
<meta property="og:description" content="d3-shape  Visualizations typically consist of discrete graphical marks, such as symbols, arcs, lines and areas. While the rectangles of a bar chart may be easy " />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/d3-shape/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/d3-shape/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/d3-shape/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
...
<p>The arc generator produces a <a class="reference external" href="https://en.wikipedia.org/wiki/Circular_sector">circular</a> or <a class="reference external" href="https://en.wikipedia.org/wiki/Annulus_%5C(mathematics%5C)">annular</a> sector, as in a pie or donut chart. If the difference between the <a class="reference external" href="#arc_startAngle">start</a> and <a class="reference external" href="#arc_endAngle">end</a> angles (the <em>angular span</em>) is greater than <a class="reference external" href="https://en.wikipedia.org/wiki/Turn_%5C(geometry%5C)#Tau_proposal">τ</a>, the arc generator will produce a complete circle or annulus. If it is less than τ, arcs may have <a class="reference external" href="#arc_cornerRadius">rounded corners</a> and <a class="reference external" href="#arc_padAngle">angular padding</a>. Arcs are always centered at ⟨0,0⟩; use a transform (see: <a class="reference external" href="http://www.w3.org/TR/SVG/coords.html#TransformAttribute">SVG</a>, <a class="reference external" href="http://www.w3.org/TR/2dcontext/#transformations">Canvas</a>) to move the arc to a different position.</p>
...
<p>The line generator produces a <a class="reference external" href="https://en.wikipedia.org/wiki/Spline_%5C(mathematics%5C)">spline</a> or <a class="reference external" href="https://en.wikipedia.org/wiki/Polygonal_chain">polyline</a>, as in a line chart. Lines also appear in many other visualization types, such as the links in <a class="reference external" href="https://observablehq.com/&#64;d3/hierarchical-edge-bundling">hierarchical edge bundling</a>.</p>
