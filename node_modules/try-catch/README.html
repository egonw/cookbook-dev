...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/try-catch/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/try-catch/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="Try Catch     " />
<meta property="og:description" content="Try Catch License NPM version Dependency Status Build Status Coverage Status  Functional try-catch wrapper  Install  npm i try-catch   Example  const tryCatch =" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/try-catch/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/try-catch/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/try-catch/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="try-catch-license-npm-version-dependency-status-build-status-coverage-status">
<h1>Try Catch <a class="reference external" href="https://tldrlegal.com/license/mit-license"><img alt="License" src="https://img.shields.io/badge/license-MIT-317BF9.svg?style=flat" /></a> <a class="reference external" href="https://npmjs.org/package/try-catch"><img alt="NPM version" src="https://img.shields.io/npm/v/try-catch.svg?style=flat" /></a> <a class="reference external" href="https://david-dm.org/coderaiser/try-catch"><img alt="Dependency Status" src="https://img.shields.io/david/coderaiser/try-catch.svg?style=flat" /></a> <a class="reference external" href="https://travis-ci.org/coderaiser/try-catch"><img alt="Build Status" src="https://img.shields.io/travis/coderaiser/try-catch/master.svg?style=flat" /></a> <a class="reference external" href="https://coveralls.io/github/coderaiser/readify?branch=master"><img alt="Coverage Status" src="https://coveralls.io/repos/coderaiser/readify/badge.svg?branch=master&amp;service=github" /></a><a class="headerlink" href="#try-catch-license-npm-version-dependency-status-build-status-coverage-status" title="Permalink to this headline">¶</a></h1>
<p>Functional <code class="docutils literal notranslate"><span class="pre">try-catch</span></code> wrapper</p>
<div class="section" id="install">
<h2>Install<a class="headerlink" href="#install" title="Permalink to this headline">¶</a></h2>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">npm</span> <span class="n">i</span> <span class="k">try</span><span class="o">-</span><span class="n">catch</span>
</pre></div>
</div>
</div>
<div class="section" id="example">
<h2>Example<a class="headerlink" href="#example" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">tryCatch</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;try-catch&#39;</span><span class="p">);</span>
<span class="kd">const</span> <span class="p">{</span><span class="nx">parse</span><span class="p">}</span> <span class="o">=</span> <span class="nx">JSON</span><span class="p">;</span>
<span class="kd">const</span> <span class="p">[</span><span class="nx">error</span><span class="p">,</span> <span class="nx">result</span><span class="p">]</span> <span class="o">=</span> <span class="nx">tryCatch</span><span class="p">(</span><span class="nx">parse</span><span class="p">,</span> <span class="s1">&#39;hello&#39;</span><span class="p">);</span>
...
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/coderaiser/try-to-catch">try-to-catch</a> - functional try-catch wrapper for promises.</p></li>
</ul>
</div>
