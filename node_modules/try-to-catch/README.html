...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/try-to-catch/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/try-to-catch/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="Try to Catch    " />
<meta property="og:description" content="Try to Catch NPM version Dependency Status Build Status Coverage Status  Functional try-catch wrapper for promises.  Install  npm i try-to-catch   API  tryToCat" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../_sources/node_modules/try-to-catch/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/try-to-catch/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/try-to-catch/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#trytocatch-fn-args">
     tryToCatch(fn, […args])
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="try-to-catch-npm-version-dependency-status-build-status-coverage-status">
<h1>Try to Catch <a class="reference external" href="https://npmjs.org/package/try-to-catch"><img alt="NPM version" src="https://img.shields.io/npm/v/try-to-catch.svg?style=flat&amp;longCache=true" /></a> <a class="reference external" href="https://david-dm.org/coderaiser/try-to-catch"><img alt="Dependency Status" src="https://img.shields.io/david/coderaiser/try-to-catch.svg?style=flat&amp;longCache=true" /></a> <a class="reference external" href="https://travis-ci.org/coderaiser/try-to-catch"><img alt="Build Status" src="https://img.shields.io/travis/coderaiser/try-to-catch/master.svg?style=flat&amp;longCache=true" /></a> <a class="reference external" href="https://coveralls.io/github/coderaiser/try-to-catch?branch=master"><img alt="Coverage Status" src="https://coveralls.io/repos/coderaiser/try-to-catch/badge.svg?branch=master&amp;service=github" /></a><a class="headerlink" href="#try-to-catch-npm-version-dependency-status-build-status-coverage-status" title="Permalink to this headline">¶</a></h1>
<p>Functional <code class="docutils literal notranslate"><span class="pre">try-catch</span></code> wrapper for <code class="docutils literal notranslate"><span class="pre">promises</span></code>.</p>
<div class="section" id="install">
<h2>Install<a class="headerlink" href="#install" title="Permalink to this headline">¶</a></h2>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">npm</span> <span class="n">i</span> <span class="k">try</span><span class="o">-</span><span class="n">to</span><span class="o">-</span><span class="n">catch</span>
</pre></div>
</div>
</div>
<div class="section" id="api">
<h2>API<a class="headerlink" href="#api" title="Permalink to this headline">¶</a></h2>
<div class="section" id="trytocatch-fn-args">
<h3>tryToCatch(fn, […args])<a class="headerlink" href="#trytocatch-fn-args" title="Permalink to this headline">¶</a></h3>
<p>Wrap function to avoid <code class="docutils literal notranslate"><span class="pre">try-catch</span></code> block, resolves <code class="docutils literal notranslate"><span class="pre">[error,</span> <span class="pre">result]</span></code>;</p>
</div>
<div class="section" id="example">
<h3>Example<a class="headerlink" href="#example" title="Permalink to this headline">¶</a></h3>
<p>Simplest example with <code class="docutils literal notranslate"><span class="pre">async-await</span></code>:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">tryToCatch</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;try-to-catch&#39;</span><span class="p">);</span>
<span class="k">await</span> <span class="nx">tryToCatch</span><span class="p">(</span><span class="nb">Promise</span><span class="p">.</span><span class="nx">reject</span><span class="p">(</span><span class="s1">&#39;hi&#39;</span><span class="p">));</span>
<span class="c1">// returns</span>
<span class="p">[</span> <span class="nb">Error</span><span class="o">:</span> <span class="nx">hi</span><span class="p">]</span>
</pre></div>
</div>
<p>Can be used with functions:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">tryToCatch</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;try-to-catch&#39;</span><span class="p">);</span>
<span class="k">await</span> <span class="nx">tryToCatch</span><span class="p">(()</span> <span class="p">=&gt;</span> <span class="mf">5</span><span class="p">);</span>
<span class="c1">// returns</span>
<span class="p">[</span><span class="kc">null</span><span class="p">,</span> <span class="mf">5</span><span class="p">]</span>
</pre></div>
</div>
...
<span class="kd">const</span> <span class="nx">tryToCatch</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;try-to-catch&#39;</span><span class="p">);</span>
...
<span class="kd">const</span> <span class="nx">readFile</span> <span class="o">=</span> <span class="nx">promisify</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">readFile</span><span class="p">);</span>
...
<span class="nx">read</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">[</span><span class="mf">2</span><span class="p">])</span>
    <span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">)</span>
    <span class="p">.</span><span class="k">catch</span><span class="p">(</span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">);</span>

<span class="k">async</span> <span class="kd">function</span> <span class="nx">read</span><span class="p">(</span><span class="nx">path</span><span class="p">)</span> <span class="p">{</span>
    <span class="kd">const</span> <span class="p">[</span><span class="nx">error</span><span class="p">,</span> <span class="nx">data</span><span class="p">]</span> <span class="o">=</span> <span class="k">await</span> <span class="nx">tryToCatch</span><span class="p">(</span><span class="nx">readFile</span><span class="p">,</span> <span class="nx">path</span><span class="p">,</span> <span class="s1">&#39;utf8&#39;</span><span class="p">);</span>
    
    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="nx">error</span><span class="p">)</span>
        <span class="k">return</span> <span class="nx">data</span><span class="p">;</span>
    
    <span class="k">if</span> <span class="p">(</span><span class="nx">error</span><span class="p">.</span><span class="nx">code</span> <span class="o">!==</span> <span class="s1">&#39;EISDIR&#39;</span><span class="p">)</span>
        <span class="k">return</span> <span class="nx">error</span><span class="p">;</span>
    
    <span class="k">return</span> <span class="k">await</span> <span class="nx">readDir</span><span class="p">(</span><span class="nx">path</span><span class="p">);</span>
<span class="p">}</span>
</pre></div>
</div>
</div>
...
<p>In old <code class="docutils literal notranslate"><span class="pre">node.js</span></code> environments that not fully supports <code class="docutils literal notranslate"><span class="pre">es2015</span></code>, <code class="docutils literal notranslate"><span class="pre">try-to-catch</span></code> can be used with:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">tryToCatch</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;try-to-catch/legacy&#39;</span><span class="p">);</span>
</pre></div>
</div>
</div>
...
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/coderaiser/try-catch">try-catch</a> - functional try-catch wrapper.</p></li>
</ul>
</div>
...
<p>MIT</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./node_modules/try-to-catch"
        },
