...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <link rel="canonical" href="https://fairplus.github.io/the-fair-cookbook/node_modules/@mermaid-js/mermaid-cli/README.html" />
...
<!-- Opengraph tags -->
<meta property="og:url"         content="https://fairplus.github.io/the-fair-cookbook/node_modules/@mermaid-js/mermaid-cli/README.html" />
<meta property="og:type"        content="article" />
<meta property="og:title"       content="mermaid-cli" />
<meta property="og:description" content="mermaid-cli  This is a command-line interface (CLI) for mermaid. It takes a mermaid definition file as input and generates an svg/png/pdf file as output.  Join " />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../_sources/node_modules/@mermaid-js/mermaid-cli/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/FAIRplus/the-fair-cookbook/issues/new?title=Issue%20on%20page%20%2Fnode_modules/@mermaid-js/mermaid-cli/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/FAIRplus/the-fair-cookbook/edit/migrating/node_modules/@mermaid-js/mermaid-cli/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#convert-mermaid-mmd-diagram-file-to-svg">
     Convert Mermaid mmd Diagram File To SVG
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#create-a-png-with-a-dark-theme-and-transparent-background">
     Create A PNG With A Dark Theme And Transparent Background
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#piping-from-stdin">
     Piping from stdin
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#see-all-available-options">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#use-docker">
   Use Docker:
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#install-locally">
   Install locally
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#install-globally">
   Install globally
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#install-with-brew">
   Install with brew
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#run-with-npx">
     Run with npx
    </a>
   </li>
  </ul>
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#for-contributors">
   For contributors
  </a>
 </li>
</ul>
  ...
  <div class="section" id="mermaid-cli">
<h1>mermaid-cli<a class="headerlink" href="#mermaid-cli" title="Permalink to this headline">¶</a></h1>
<p>This is a command-line interface (CLI) for <a class="reference external" href="https://mermaid-js.github.io/">mermaid</a>. It takes a mermaid definition file as input and generates an svg/png/pdf file as output.</p>
<p><a class="reference external" href="https://join.slack.com/t/mermaid-talk/shared_invite/enQtNzc4NDIyNzk4OTAyLWVhYjQxOTI2OTg4YmE1ZmJkY2Y4MTU3ODliYmIwOTY3NDJlYjA0YjIyZTdkMDMyZTUwOGI0NjEzYmEwODcwOTE"><img alt="Join our Slack!" src="https://img.shields.io/static/v1?message=join%20chat&amp;color=9cf&amp;logo=slack&amp;label=slack" /></a> <a class="reference external" href="https://percy.io/Mermaid/mermaid-cli"><img alt="This project is using Percy.io for visual regression testing." src="https://percy.io/static/images/percy-badge.svg" /></a> <img alt="Build, test and deploy" src="https://github.com/mermaid-js/mermaid-cli/workflows/Build,%20test%20and%20deploy%20mermaid-cli%20Docker%20image/badge.svg" /></p>
<div class="section" id="example-usage">
<h2>Example Usage<a class="headerlink" href="#example-usage" title="Permalink to this headline">¶</a></h2>
<p>Locate how to call the mmdc executable for your preferred method i.e. Docker,
Yarn, NPM, global install, etc. Try these examples to get started quickly.</p>
<div class="section" id="convert-mermaid-mmd-diagram-file-to-svg">
<h3>Convert Mermaid mmd Diagram File To SVG<a class="headerlink" href="#convert-mermaid-mmd-diagram-file-to-svg" title="Permalink to this headline">¶</a></h3>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>mmdc -i input.mmd -o output.svg
</pre></div>
</div>
</div>
<div class="section" id="create-a-png-with-a-dark-theme-and-transparent-background">
<h3>Create A PNG With A Dark Theme And Transparent Background<a class="headerlink" href="#create-a-png-with-a-dark-theme-and-transparent-background" title="Permalink to this headline">¶</a></h3>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>mmdc -i input.mmd -o output.png -t dark -b transparent
</pre></div>
</div>
</div>
<div class="section" id="piping-from-stdin">
<h3>Piping from stdin<a class="headerlink" href="#piping-from-stdin" title="Permalink to this headline">¶</a></h3>
<p>You can easily pipe input from stdin. This example shows how to use a heredoc to
send a diagram as stdin to mermaid-cli (mmdc).</p>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>cat <span class="s">&lt;&lt; EOF  | mmdc</span>
<span class="s">    graph TD</span>
<span class="s">    A[Client] --&gt; B[Load Balancer]</span>
<span class="s">EOF</span>
</pre></div>
</div>
</div>
<div class="section" id="see-all-available-options">
<h3>See All Available Options<a class="headerlink" href="#see-all-available-options" title="Permalink to this headline">¶</a></h3>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>mmdc -h
</pre></div>
</div>
</div>
</div>
<div class="section" id="use-docker">
<h2>Use Docker:<a class="headerlink" href="#use-docker" title="Permalink to this headline">¶</a></h2>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>docker pull minlag/mermaid-cli
</pre></div>
</div>
<p>or e.g. version 8.8.0</p>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>docker pull minlag/mermaid-cli:8.8.0
</pre></div>
</div>
<p>The container looks for input files in <code class="docutils literal notranslate"><span class="pre">/data</span></code>. So for example, if you have a
diagram defined on your system in <code class="docutils literal notranslate"><span class="pre">/path/to/diagrams/diagram.mmd</span></code>, you can use
the container to generate an SVG file as follows:</p>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>docker run -it -v /path/to/diagrams:/data minlag/mermaid-cli -i /data/diagram.mmd
</pre></div>
</div>
</div>
<div class="section" id="install-locally">
<h2>Install locally<a class="headerlink" href="#install-locally" title="Permalink to this headline">¶</a></h2>
<p>Some people are <a class="reference external" href="https://github.com/mermaidjs/mermaid.cli/issues/15">having issue</a>
installing this tool globally. Installing it locally is an alternative solution:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">yarn</span> <span class="n">add</span> <span class="nd">@mermaid</span><span class="o">-</span><span class="n">js</span><span class="o">/</span><span class="n">mermaid</span><span class="o">-</span><span class="n">cli</span>
<span class="o">./</span><span class="n">node_modules</span><span class="o">/.</span><span class="n">bin</span><span class="o">/</span><span class="n">mmdc</span> <span class="o">-</span><span class="n">h</span>
</pre></div>
</div>
<p>Or use NPM:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">npm</span> <span class="n">install</span> <span class="nd">@mermaid</span><span class="o">-</span><span class="n">js</span><span class="o">/</span><span class="n">mermaid</span><span class="o">-</span><span class="n">cli</span>
<span class="o">./</span><span class="n">node_modules</span><span class="o">/.</span><span class="n">bin</span><span class="o">/</span><span class="n">mmdc</span> <span class="o">-</span><span class="n">h</span>
</pre></div>
</div>
</div>
<div class="section" id="install-globally">
<h2>Install globally<a class="headerlink" href="#install-globally" title="Permalink to this headline">¶</a></h2>
<p>❗️ We do <strong>NOT</strong> recommend installing it globally because both YARN and NPM
could fail to install a command-line tool globally properly due to weird
permission issues.
<code class="docutils literal notranslate"><span class="pre">yarn</span> <span class="pre">global</span> <span class="pre">add</span> <span class="pre">&#64;mermaid-js/mermaid-cli</span></code> or <code class="docutils literal notranslate"><span class="pre">npm</span> <span class="pre">install</span> <span class="pre">-g</span> <span class="pre">&#64;mermaid-js/mermaid-cli</span></code></p>
</div>
<div class="section" id="install-with-brew">
<h2>Install with <a class="reference external" href="https://brew.sh">brew</a><a class="headerlink" href="#install-with-brew" title="Permalink to this headline">¶</a></h2>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">brew</span> <span class="n">install</span> <span class="n">mermaid</span><span class="o">-</span><span class="n">cli</span>
</pre></div>
</div>
<div class="section" id="run-with-npx">
<h3>Run with npx<a class="headerlink" href="#run-with-npx" title="Permalink to this headline">¶</a></h3>
<p><a class="reference external" href="https://www.npmjs.com/package/npx"><code class="docutils literal notranslate"><span class="pre">npx</span></code></a> is installed by default with NPM. It
downloads and runs commands at the same time.  To use Mermaid CLI with npx, you
need to use the <code class="docutils literal notranslate"><span class="pre">-p</span></code> flag because the package name is different than the command
it installs (<code class="docutils literal notranslate"><span class="pre">mmdc</span></code>).  <code class="docutils literal notranslate"><span class="pre">npx</span> <span class="pre">-p</span> <span class="pre">&#64;mermaid-js/mermaid-cli</span> <span class="pre">mmdc</span> <span class="pre">-h</span></code></p>
</div>
</div>
<div class="section" id="known-issues">
<h2>Known issues<a class="headerlink" href="#known-issues" title="Permalink to this headline">¶</a></h2>
<ol class="simple">
<li><p><span class="xref myst">Linux sandbox issue</span></p></li>
</ol>
</div>
...
<p>Contributions are welcome. See the <span class="xref myst">contribution guide</span>.</p>
</div>
</div>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./node_modules/@mermaid-js/mermaid-cli"
        },
